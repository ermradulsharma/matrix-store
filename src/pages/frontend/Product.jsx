...
function Product() {
    ...
    const filteredProducts = products.filter((product) => {
        ...
        const matchesPrice = !filters.priceRange || (filters.priceRange === "low" && product.price < 50) || (filters.priceRange === "medium" && product.price >= 50 && product.price <= 100) || (filters.priceRange === "high" && product.price > 100);
    ...
    for (let i = 1; i <= Math.ceil(filteredProducts.length / productsPerPage); i++) {
        pageNumbers.push(<Pagination.Item key={i} active={i === currentPage} onClick={() => paginate(i)}>{i}</Pagination.Item>);
    }
    return (
